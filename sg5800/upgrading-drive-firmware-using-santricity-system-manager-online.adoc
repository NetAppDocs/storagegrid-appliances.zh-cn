...
---
= 使用 SANtricity System Manager 在线方法升级 SG5800 驱动器固件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
属于没有冗余的卷的驱动器必须使用进行更新 link:upgrading-drive-firmware-using-santricity-system-manager-offline.html["脱机方法"]。
...
** 使用网格管理器并选择 *节点* > *_存储节点_* > *SANtricity System Manager*

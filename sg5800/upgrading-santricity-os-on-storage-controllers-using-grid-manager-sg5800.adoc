...
summary: 您可以使用 Grid Manager 应用升级。 
---
= 使用 Grid Manager 升级 SG5800 存储控制器上的 SANtricity 操作系统
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以使用网格管理器应用升级。您也可以link:upgrading-santricity-os-on-storage-controller.html["使用维护模式应用升级"]。

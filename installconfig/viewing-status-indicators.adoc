...
* <<appliance_indicators_sg120_sg1200,设备指示灯和按钮>>
* <<general_boot_codes_sg120_sg1200,常规启动代码>>
* <<ssd_indicators_sg120_sg1200,SSD 指示灯>>


使用此信息来帮助 link:troubleshooting-hardware-installation-sg120-and-sg1200.html["SG120 和 SG1200 硬件安装故障排除"]。

[[appliance_indicators_sg120_sg1200]]
设备指示灯和按钮::
+
--
下图显示了 SG120 和 SG1200 设备正面的指示灯和按钮。

image::../media/sg120_sg1200_front_indicators.png[前部指示灯 - SG120 和 SG1200]
...
。
 a| 
SG120 和 SG1200 设备未使用此指示灯，因此保持关闭状态。

|===
--


下图显示了电源的位置，并标识了 SG120 和 SG1200 背面的 LED。其他状态和活动指示灯位于设备端口上。这些 LED 可能因设备型号而异。
...
+
--
下图显示了 SG120 和 SG1200 设备上的 SSD 指示灯。
...
* <<appliance_indicators_SG6200,设备指示灯和按钮>>
* <<general_boot_codes_SG6200,常规启动代码>>
* <<ssd_indicators_SG6200,SSD 指示灯>>


使用此信息来帮助 link:troubleshooting-hardware-installation-sg6200.html["SG6200 硬件安装故障排除"]。

[[appliance_indicators_SG6200]]
设备指示灯和按钮::
+
--
下图显示了 SG6200 设备正面的指示灯和按钮。

image::../media/s25_front_indicators.png[前指示灯 - SG6200]
...
。
 a| 
此灯不被 SG6200 设备使用，并且保持关闭状态。

|===
--


下图显示了电源的位置，并标识了 SGF6212 和 SG6200-CN 背面的 LED。其他状态和活动指示灯位于设备端口上。这些 LED 可能因设备型号而异。

image::../media/s25_rear_leds.png[后部 LED SGF6212 和 SG6200-CN]
...
+
--
下图显示了 SGF6212 或 SG6260 设备上的 SSD 指示灯。
...
*注意：*如果将新的工作 SSD 插入工作 SGF6212 或 SG6260 StorageGRID 节点，SSD 上的 LED 最初应闪烁，但在系统确定驱动器有足够容量且正常工作后立即停止闪烁。

...
* link:../sg5800/changing-link-configuration-of-sg5800-controller.html["更改SG可能性 控制器的链路配置"]
...
+
*** 要添加子网、请单击最后一个条目右侧的插入图标image:../media/icon_plus_sign_black_on_white.gif["插入图标"]。
*** 要删除未使用的子网，请单击删除图标image:../media/icon_nms_delete_new.gif["删除图标"]。

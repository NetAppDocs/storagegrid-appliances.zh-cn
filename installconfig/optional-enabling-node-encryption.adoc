...
此外，在启用节点加密后启用 FIPS 模式时，NetApp StorageGRID Kernel Crypto API 6.1.129-1-ntap1-amd64 模块用于加密静态数据。有关详细信息，请参见 https://docs.netapp.com/us-en/storagegrid/admin/manage-tls-ssh-policy.html#select-a-security-policy["选择安全策略"^]。

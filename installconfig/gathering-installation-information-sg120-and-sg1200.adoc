...
在安装 SG120 或 SG1200 服务设备之前，请确认您的 StorageGRID 系统正在使用所需版本的 StorageGRID 软件。
...
image::../media/sg120_rj_45_ports.png[SG120 RJ-45 端口]

SG1200 RJ-45 端口：

image::../media/sg1200_rj_45_ports.png[SG1200 RJ-45 端口]
...
*注意：* 对于 SG1200，10- 和 25-GbE 速度需要使用 QSA 适配器。
...
image::../media/sg120_bmc_management_port.png[SG120 管理端口]

SG1200 BMC 管理端口：

image::../media/sg1200_bmc_management_port.png[SG1200 BMC 管理端口]
...
当 link:configuring-network-links.html["正在配置网络链路"] 对于 SG120 和 SG1200 设备时，您可以为连接到网格网络和可选客户端网络的端口以及连接到可选管理网络的 1-GbE1/10-GbE 管理端口使用端口绑定。端口绑定通过在 StorageGRID 网络和设备之间提供冗余路径来帮助保护您的数据。
...
固定端口绑定模式是网络端口的默认配置。图中显示了 SG1200 或 SG120 上的网络端口如何以固定端口绑定模式绑定。

SG120:

image::../media/sg120_fixed_port.png[SG120 固定端口绑定模式]

SG1200:

image::../media/sg1200_fixed_port.png[SG1200 固定端口绑定模式]
...
image::../media/sg120_aggregate_ports.png[SG120 聚合端口绑定模式]

SG1200:

image::../media/sg1200_aggregate_ports.png[SG1200 聚合端口绑定模式]
...
image::../media/sg120_bonded_management_ports.png[SG120 绑定网络管理端口]

SG1200:

image::../media/sg1200_bonded_management_ports.png[SG1200 绑定网络管理端口]

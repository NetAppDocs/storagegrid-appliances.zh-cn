...
NOTE: 对端口重新映射的支持已弃用，并将在未来的版本中删除。要删除重新映射的端口，请参阅 https://docs.netapp.com/us-en/storagegrid/maintain/removing-port-remaps.html["删除StorageGRID设备上的端口重新映射"^]。
...
+
此处显示的名称将是设备节点的系统名称。系统名称是内部StorageGRID操作所必需的，并且不能更改。要更改设备节点的显示名称，请参阅 https://docs.netapp.com/us-en/storagegrid/maintain/rename-grid-site-node.html#how-to-rename-grid-sites-or-nodes["如何重命名网格、站点或节点"^]。
...
.下一步是什么？
了解 link:https://docs.netapp.com/us-en/storagegrid/swnodes/navigating-to-grid-manager.html["配置网格并完成安装"^] 和 link:monitoring-appliance-installation.html["监控设备安装"]。

...
** link:installing-appliance-in-cabinet-or-rack-sg120-and-sg1200.html["SG120 和 SG1200"]
...
. link:accessing-and-configuring-santricity-system-manager.html["访问并配置SANtricity 系统管理器"] (SG6260、SG6160、SG5700、SG5800 和 SG6000)
. link:configuring-bmc-interface.html["配置BMC接口"] (SG6200、SG6100、SG6000 和服务设备)
. 执行可选的设置步骤
+
** link:optional-enabling-node-encryption.html["启用节点或驱动器加密"]
** link:optional-changing-raid-mode.html["更改 RAID 模式"] (SG6260、SG6160、SG6000、SG5860 和 SG5760)
...
[role="quick-margin-para"]
部署所有节点后，请使用 Grid Manager link:https://docs.netapp.com/us-en/storagegrid/swnodes/navigating-to-grid-manager.html["配置网格并完成安装"^]。

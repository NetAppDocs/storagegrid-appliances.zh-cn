...
在安装 SGF6212 或 SG6260 设备之前，请确认您的 StorageGRID 系统正在使用所需版本的 StorageGRID 软件。
...
将 SG6260 设备中的两个存储控制器连接到将用于 SANtricity System Manager 的管理网络。控制器 A 在顶部，控制器 B 在底部。
...
SGF6212 设备上的 RJ-45 端口：

image::../media/sgf6212_rj_45_ports.png[SGF6212 RJ-45 端口]

SG6200-CN 控制器上的 RJ-45 端口：

image::../media/sg6200_cn_rj_45_ports.png[SG6200-CN RJ-45 端口]
...
下图显示了 SGF6212 和 SG6200-CN 上的 BMC 管理端口。

_SGF6212_

image::../media/sgf6212_bmc_management_port.png[SGF6212 管理端口]

_SG6200-CN_

image::../media/sg6200_cn_bmc_management_port.png[SG6200-CN 管理端口]
...
当 link:configuring-network-links.html["正在配置网络链路"] SGF6212 设备时，您可以为连接到网格网络和可选客户端网络的端口以及连接到可选管理网络的 1/10-GbE 管理端口使用端口绑定。端口绑定通过在 StorageGRID 网络和设备之间提供冗余路径来帮助保护您的数据。
...
image::../media/sgf6212_fixed_port.png[SGF6212 固定端口绑定模式]

_SG6200-CN：_

image::../media/sg6200_cn_fixed_port.png[SG6200-CN 固定端口绑定模式]
...
image::../media/sgf6212_aggregate_ports.png[SGF6212 聚合端口绑定模式]

_SG6200-CN：_

image::../media/sg6200_cn_aggregate_ports.png[SG6200-CN 聚合端口绑定模式]
...
image::../media/sgf6212_bonded_management_ports.png[SGF6212 网络管理端口]

_SG6200-CN：_

image::../media/sg6200_cn_bonded_management_ports.png[SG6200-CN 网络管理端口]

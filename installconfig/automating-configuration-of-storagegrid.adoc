...
NOTE: 您也可以使用配置系统 https://docs.netapp.com/us-en/storagegrid-118/primer/exploring-grid-manager.html["网格管理器"^] 或 link:overview-of-installation-rest-apis.html["安装 API"]。

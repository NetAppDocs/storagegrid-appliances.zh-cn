...
== [[view-boot-codes]]查看启动代码（仅限 SGF6212 和 SG6260）
...
.. 确认 SG6200-CN 控制器和两个存储控制器之间的四个互连电缆已牢固连接。
.. 根据需要更换一根或多根缆线，然后重试。
...
== [[view-error-codes]]查看错误代码（仅限 SGF6212 和 SG6260）
...
=== 扩展盘架未出现在 Appliance Installer (SG6260) 中
...
. 确认已打开扩展架的电源。请参阅 link:connecting-power-cords-and-applying-power.html["连接电源线并接通电源 (SG6200)"]。
. 如果您需要有关解决问题描述 的帮助，请联系技术支持。

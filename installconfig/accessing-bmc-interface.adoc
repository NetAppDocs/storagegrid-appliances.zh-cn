...
summary: 在某些设备型号上，您可以使用 BMC 管理端口的 DHCP 或静态 IP 地址来访问 BMC 接口。 
---
= 访问 StorageGRID 设备上的 BMC 接口
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120
--
image::../media/sg120_bmc_management_port.png[BMC 管理端口 SG120]
...
.SG1200
--
image::../media/sg1200_bmc_management_port.png[BMC 管理端口 SG1200]
...
image::../media/sgf6212_bmc_management_port.png[BMC 管理端口 SGF6212]

_SG6200-CN_:

image::../media/sg6200_cn_bmc_management_port.png[BMC 管理端口 SG6200-CN]

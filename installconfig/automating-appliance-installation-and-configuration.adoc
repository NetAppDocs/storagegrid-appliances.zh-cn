...
* 生成包含配置详细信息的 JSON 文件。与您的 NetApp 专业服务顾问合作，使用 link:https://configbuilder.netapp.com/Index.aspx["NetApp ConfigBuilder工具"^]（需要登录）完成以下步骤：
+
...
. 在“上传 JSON”部分中，浏览并选择要上传的 JSON 配置文件。
+

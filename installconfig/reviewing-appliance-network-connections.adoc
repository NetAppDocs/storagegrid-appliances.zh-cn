...
* link:gathering-installation-information-sg120-and-sg1200.html["SG120 和 SG1200"]
...
* *SANtricity 管理网络*（存储设备可选，SGF6112 和 SGF6212 不需要）：此网络提供对 SANtricity System Manager 的访问，允许您监控和管理设备和存储控制器机架中的硬件组件。此管理网络可以与 StorageGRID 的管理网络相同，也可以是独立的管理网络。
* *BMC 管理网络*（SG6000、SG6100、SG6200 和服务设备可选）：此网络提供对 SG6000、SG6100、SG6200 和服务设备中基板管理控制器的访问，使您可以监控和管理设备中的硬件组件。此管理网络可以与 StorageGRID 的管理网络相同，也可以是独立的管理网络。
+

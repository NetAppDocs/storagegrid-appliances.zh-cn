...
summary: 您必须访问 StorageGRID 设备安装程序，以验证安装程序版本并配置设备与三个 StorageGRID 网络（网格网络、管理网络（可选）和客户端网络（可选））之间的连接。 
---
...
.SG120
--
image::../media/sg120_admin_network_port.png[SG120 上的管理网络端口]
...
.SG1200
--
image::../media/sg1200_admin_network_port.png[SG1200 上的 Admin Network 端口]
...
.SG6200-CN
--
image::../media/sg6200_cn_admin_network_port.png[SG6200-CN 控制器上的 Admin Network 端口]
...
.SGF6212
--
image::../media/sgf6212_admin_network_port.png[SGF6212 上的管理网络端口]
...
image::../media/sg120_link_local_port.png[SG120 链路本地连接]
...
image::../media/sg1200_link_local_port.png[SG1200 链路本地连接]
...
.SG6200-CN
--
使用以太网电缆将维修笔记本电脑直接连接到 SG6200-CN 控制器上最右边的 RJ-45 端口。

image::../media/sg6200_cn_link_local_port.png[SG6200-CN 管理端口位置]
...
image::../media/sgf6212_link_local_port.png[SGF6212 链路本地连接]

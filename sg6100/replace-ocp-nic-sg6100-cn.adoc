...
summary: '如果 SG6100-CN 中的网络接口卡 (NIC) 无法正常工作或出现故障，则可能需要更换该卡。' 
---
= 更换 SG6100-CN 中的外部 NIC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.关于此任务
为防止服务中断，请在开始更换网络接口卡 (NIC) 之前确认所有其他存储节点都已连接到电网，或者在可以接受服务中断时间的计划维护时段内更换 NIC。查看有关 https://docs.netapp.com/us-en/storagegrid/monitor/monitoring-system-health.html#monitor-node-connection-states["监控节点连接状态"^]。

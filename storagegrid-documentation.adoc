...
[role="lead"]
请转至 https://docs.netapp.com/us-en/storagegrid/index.html["StorageGRID 12.1 文档"^]，了解如何配置和使用 StorageGRID 12.1 系统。
...
* https://docs.netapp.com/us-en/storagegrid-120/index.html["StorageGRID 12.0 文档"^]
* https://docs.netapp.com/us-en/storagegrid-119/index.html["StorageGRID 11.9文档"^]

...
summary: '如果 SG120 或 SG1200 中的网络接口卡 (NIC) 无法正常工作或出现故障，则可能需要更换该卡。' 
---
= 更换 SG120 或 SG1200 中的 NIC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果 SG120 或 SG1200 中的网络接口卡 (NIC) 无法正常工作或出现故障，则可能需要更换该卡。
...
.开始之前
* 您拥有正确的替代NIC。
* 您有link:locating-sg120-and-sg1200-in-data-center.html["物理定位 SG120 或 SG1200 设备"]，您正在数据中心中更换 NIC。
+
...
+
image::../media/drw_s2025_io_numbers_ieops-2554.svg[StorageGRID 设备机箱中的内部 NIC 位置]
...
NOTE: SG1200 设备支持更高速度的网络端口，并可能安装了更高速度的 NIC。

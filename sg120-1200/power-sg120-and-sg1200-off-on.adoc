...
[role="lead"]
您可以关闭 SG120 或 SG1200 设备并重新打开电源以执行维护。



== 关闭 SG120 或 SG1200 设备
...
== 启动 SG120 或 SG1200 并验证运行

完成维护后，打开控制器电源。

.开始之前
* 您已link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["已将控制器安装在机柜或机架中"]并连接了数据线和电源线。
* 您有 link:locating-sg120-and-sg1200-in-data-center.html["物理上位于数据中心内的控制器"]。

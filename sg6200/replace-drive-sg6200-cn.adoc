...
summary: SG6260 设备在 SG6200-CN 控制器中包含两个 SSD 驱动器，用作读缓存。如果其中一个驱动器发生故障，您必须尽快更换它，以最大限度地减少潜在的性能影响。 
---
= 更换 SG6200-CN 中的驱动器
:allow-uri-read: 
:icons: font
...
[role="lead"]
SG6260 设备在 SG6200-CN 控制器中包含两个 SSD 驱动器，用作读缓存。如果其中一个驱动器发生故障，您必须尽快更换它，以最大限度地减少潜在的性能影响。
...
+
image::../media/sg6260_front_with_ssds.png[SG6260 中的 SSD 位置]

...
summary: 您可以关闭 SG6200 设备并重新打开电源以执行维护。 
---
= 关闭和打开 SGF6212 设备或 SG6200-CN 控制器电源
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以关闭 SGF6212 设备或 SG6200-CN 控制器，然后重新打开它们以执行维护。



[[shut-down-the-sgf6212-appliance-or-sg6200-cn-controller]]
== 关闭 SGF6212 设备或 SG6200-CN 控制器
...
== 启动 SGF6212 或 SG6200-CN 并验证运行

完成维护后，打开控制器电源。

.开始之前
* 您已link:reinstalling-sg6200-into-cabinet-or-rack.html["已将控制器安装在机柜或机架中"]并连接了数据线和电源线。
* 您有 link:locating-sg6200-in-data-center.html["物理上位于数据中心内的控制器"]。

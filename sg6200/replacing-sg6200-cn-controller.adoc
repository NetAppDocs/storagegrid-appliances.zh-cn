...
summary: 如果 SG6200-CN 控制器无法正常工作或出现故障，则可能需要更换。 
---
= 更换 SG6200-CN 控制器
:allow-uri-read: 
:icons: font
...
[role="lead"]
如果 SG6200-CN 控制器无法正常工作或出现故障，则可能需要更换。

.关于此任务
更换 SG6200-CN 控制器时，设备存储节点将无法访问。如果 SG6200-CN 控制器工作正常，您可以在此过程开始时执行受控关机。
...
* 您已在数据中心中找到要更换的控制器。
+
link:locating-sg6200-in-data-center.html["在数据中心中找到控制器"]
...
. 如果 SG6200-CN 控制器的功能足以允许受控关机，link:power-sg6200-off-on.html["关闭 SG6200-CN 控制器"]。
